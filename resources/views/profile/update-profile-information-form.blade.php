<x-jet-form-section submit="updateProfileInformation">
    ...
    <x-slot name="form">
        ...
        {{-- <!-- Job Title -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="email" value="{{ __('Job Title') }}" />
        ...
        <!-- Organisation -->
        <div class="col-span-6 sm:col-span-4">
            <x-jet-label for="organisation" value="{{ __('Organisation') }}" />
            <x-jet-input id="organisation" type="text" class="mt-1 block w-full" wire:model.defer="state.organisation" />
            <x-jet-input-error for="organisation" class="mt-2" />
        </div> --}}
    </x-slot>
