                                     ...
                                     <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                           ...
                                           <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                              <a href="{{ route('matrixcategories.show', $category->id) }}" class="inline-block rounded-full
                                                 text-xs font-bold mr-4 opacity-90 hover:opacity-100"><x-heroicon-s-cog class="h-5 w-5 text-blue-500" /></a>
                                                 @can('can_edit_matrix_cat')
                                              <a href="{{ route('matrixcategories.edit', $category->id) }}" class="inline-block rounded-full mr-4"><x-heroicon-s-pencil-alt class="h-5 w-5 text-purple-700" /></a>
                                                @endcan
