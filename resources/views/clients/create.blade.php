    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" class="form-prevent-double-click" action="{{ route('clients.store') }}">
                    @csrf
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <textarea name="client_address" " id="client_address" class="form-input rounded-md shadow-sm mt-1 block w-full">{{ old('client_address') }}</textarea>
