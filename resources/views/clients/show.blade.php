   ...
   <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
      ...
      <div class="bg-white shadow overflow-hidden sm:rounded-lg">
         <div class="px-4 py-5 sm:px-6 bg-purple-600">
            ...
            <p class="mb-1 mt-1 ml-1 max-w-2xl text-xs text-white">
               Elected board members on the TMO board
            </p>
         </div>
         <div class="border-t border-gray-200">
            <div class="shadow overflow-hidden border-b border-gray-200">
                <div class="px-1 py-4 mx-auto sm:max-w-xl bg-white md:max-w-full lg:max-w-screen-xl md:px-6 lg:px-2 lg:py-5">
                   <div class="pr-3 pl-3 grid max-w-full gap-5 row-gap-3 sm:row-gap-5 lg:max-w-full lg:grid-cols-5 sm:mx-auto">
                        ...
                        <div class="flex-row gap-4 flex justify-center items-center">
                            <div class="flex-shrink-0">
                                <a href="#" class="block relative">
                                    <x-heroicon-o-user-group class="w-6 h-6 text-teal-500 mr-3"/>
                                </a>
                            </div>
                            <div class=" flex flex-col">
                                <span class="text-gray-600 dark:text-white text-md font-medium">
                                    {{ $member->elected_name }}
                                </span>
