                ...
                <form method="post" action="{{ route('clients.update', $clients->id) }}">
                    ...
                    <div class="shadow overflow-hidden sm:rounded-md">
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="client_chair" id="client_chair" value="{{ $clients->client_chair }} " class="form-input rounded-md shadow-sm mt-1 block w-full" />
                            @error('client_chair')
                                <p class="text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="email" name="client_chair_email" id="client_chair_email" value="{{ $clients->client_chair_email }} " class="form-input rounded-md shadow-sm mt-1 block w-full" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="client_chair_contact" id="client_chair_contact" value="{{ $clients->client_chair_contact }} " class="form-input rounded-md shadow-sm mt-1 block w-full" />
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            ...
                            <input type="text" name="client_secretary" id="client_secretary" value="{{ $clients->client_secretary }} " class="form-input rounded-md shadow-sm mt-1 block w-full" />
