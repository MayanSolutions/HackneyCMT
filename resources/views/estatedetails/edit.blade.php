    ...
    <div>
        <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
            ...
            <div class="mt-5 md:mt-0 md:col-span-2">
                <form method="post" class="form-prevent-double-click" action="{{ route('estatedetails.update', $clients->EstateDetails->id) }}">
                    @csrf
                    @method('put')
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="no_of_units" value="{{ $clients->EstateDetails->no_of_units }}" id="no_of_units" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                                    @error('no_of_units')
                                ...
                                <div>
                                    ...
                                    <input type="number" name="freeholders" value="{{ $clients->EstateDetails->freeholders }}" id="freeholders" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                                    @error('freeholders')
                                        <p class="text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-5">
                                <div>
                                    ...
                                    <input type="number" name="leaseholders" value="{{ $clients->EstateDetails->leaseholders}}" id="leaseholders" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                                    @error('leaseholders')
                                        <p class="text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="tenants" value="{{ $clients->EstateDetails->tenants}}" id="tenants" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                                    @error('tenants')
                                        <p class="text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                        ...
                        <div class="px-4 py-5 bg-white sm:p-6">
                            <div class="grid grid-cols-2 gap-4 mt-5">
                                <div>
                                    ...
                                    <input type="number" name="comm_halls" id="comm_halls" value="{{ $clients->EstateDetails->comm_halls}}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                                    @error('comm_halls')
                                    <p class="text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                                ...
                                <div>
                                    ...
                                    <input type="number" name="outside_areas" id="outside_areas" value="{{ $clients->EstateDetails->outside_areas}}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
                                    @error('outside_areas')
                                        <p class="text-sm text-red-600">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div class="grid grid-cols-2 gap-4 mt-5">
                                <div>
                                    ...
                                    <input type="number" name="communal_facilities" id="communal_facilities" value="{{ $clients->EstateDetails->communal_facilities}}" class="form-input rounded-md shadow-sm mt-1 block w-full" />
