                                     ...
                                     <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        <tr>
                                           ...
                                           <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                              <a href="{{ route('estatedetails.show', $client->id) }}" class="inline-block rounded-full
                                                text-xs font-bold mr-4 opacity-90 hover:opacity-100"><x-heroicon-s-eye class="h-5 w-5 text-green-700" /></a>
                                                 @can('can_edit_estates')
                                              <a href="{{ route('estatedetails.edit', $client->id) }}" class="inline-block rounded-full mr-4"><x-heroicon-s-pencil-alt class="h-5 w-5 text-purple-700" /></a>
                                                 @endcan
