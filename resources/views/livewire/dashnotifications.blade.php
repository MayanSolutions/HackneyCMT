...
<div class="container mx-auto items-center">
    <div class="mt-4 mb-4 mr-4 ml-10 shadow-lg rounded-2xl bg-white dark:bg-gray-700 items-center">
        <p class="font-bold text-md p-4 text-black dark:text-white">
            My Notifications
        </p>
        <span class="font-bold text-md underline p-4 text-xs text-teal-500 dark:text-gray-300 dark:text-white">
            @if($countNotifications > 0)
            {{ $countNotifications }} Unread Notifications
            @else
            0 unread Notifications
            @endif
        </span>
        <button class="float-right text-xs" wire:click="read"><x-heroicon-o-x-circle class="mr-3 w-5 h-5 text-red-500"/></button>
        <ul>
            ...
            <li class="flex items-center text-gray-600 dark:text-gray-200 justify-between py-3 border-b-2 border-gray-100 dark:border-gray-800">
                ...
                <span class="font-bold text-md p-2 text-xs text-teal-500 dark:text-gray-300 dark:text-white ml-1">
            ...
            <li class="flex items-center text-gray-600 dark:text-gray-200 justify-between py-3 border-b-2 border-gray-100 dark:border-gray-800">
                <div class="flex items-center justify-start text-sm">
                    <span class="font-bold text-md p-4 text-xs text-grey-500 dark:text-gray-300 dark:text-white ml-2">
                        <x-heroicon-o-badge-check class="w-5 h-5 text-teal-500"/>
                    </span>
