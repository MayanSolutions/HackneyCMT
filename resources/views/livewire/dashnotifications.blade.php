...
<div class="container w-1/2 items-center">
    <div class="mt-4 mb-4 mr-4 shadow-lg rounded-2xl bg-white dark:bg-gray-700 items-center">
        ...
        <span class="ml-3 font-bold text-md underline p-4 text-xs text-teal-500 dark:text-gray-300 dark:text-white">
            ...
            You have {{ $countNotifications }} recent Notifications
            @else
